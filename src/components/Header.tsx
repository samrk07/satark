...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md shadow-xl border-b-4 border-gradient-to-r from-blue-600 to-orange-600 sticky top-0 z-50">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 rounded-xl hover:bg-orange-200 dark:hover:bg-orange-800 transition-colors font-medium text-sm"
            >
            ...
            {/* Notifications */}
            <button className="relative p-3 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
            ...
            {/* User Menu */}
            <div className="flex items-center space-x-3 bg-gray-100 dark:bg-gray-700 rounded-2xl px-4 py-2">
